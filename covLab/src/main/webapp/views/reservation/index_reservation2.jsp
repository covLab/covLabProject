...
<script language="javascript">
	...
	function getOrderOpt(){
		var orderopt = null;
		orderopt = $(":radio[name='list_order']:checked").val();
		request.open("Post","../../java/reservation/model/controller/indexReservation?orderopt="+encodeURIComponent(orderopt),true);
	}
