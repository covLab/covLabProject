			...
			<div class="nano-content">
				<ul>
					...
					<ul>                                                
						...
						<% if(loginMember == null ){ //일반유져 %> <!--회원가입 창 만들었는데 아니다 싶으면 지워주세여  -->
                  ...
                  <ul>
					...
					<li><a><i class="ti-close" onclick="javascript:location.href='logout';"></i> Logout</a></li>
				</ul>
			</div>
		</div>
	</div>
