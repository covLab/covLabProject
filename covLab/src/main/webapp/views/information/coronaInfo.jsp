...
<ul>
	...
	<li>주요 증상으로는 발열 (37.5℃ 이상), 기침, 호흡곤란, 오한, 근육통, 두통, 인후통, 후각/미각 손실</li>
	<li>그 외에 피로, 식욕감소, 가래, 소화기증상(오심, 구토, 설사 등), 혼돈, 어지러움, 콧물이나 코막힘, 객혈, 흉통,
	     결막염, 피부 증상 등이 다양하게 나타남</li>
</ul>
<p><a href="#top">맨 위로 이동</a></p>
<hr>
<h5 id="coronainfo03">4. 코로나 예방법</h5>
<ul>
	<li>식약처에서 승인된 코로나 19 <a href="vaccinInfo.jsp#vaccineinfo01"><u>백신</u></a></li>
	<li>올바른 손씻기</li>
	<li>기침 예절 준수</li>
	<li>씻지 않은 손으로 눈, 코, 입 만지지 않기</li>
	<li>주위환경을 자주 소독하고 환기하기</li>
</ul>
<p><a href="#top">맨 위로 이동</a></p>
<hr>
